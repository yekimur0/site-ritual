...
/* harmony import */ var _functions_my_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/my-select */ "./src/js/functions/my-select.js");
/* harmony import */ var _functions_listener__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/listener */ "./src/js/functions/listener.js");
...
/* harmony import */ var _product_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product-slider */ "./src/js/product-slider.js");
/* harmony import */ var _product_slider__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_product_slider__WEBPACK_IMPORTED_MODULE_5__);
...
const swiper_reviews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-review', {
  slidesPerView: 3,
  spaceBetween: 20,
  navigation: {
...
const swiper_news = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-news', {
  slidesPerView: 4,
  spaceBetween: 20,
  navigation: {
...
const swiper_about_gallery = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-gallery-swiper', {
  spaceBetween: 20,
  navigation: {
    prevEl: '.gallery-about-slider .prev',
    nextEl: '.gallery-about-slider .next'
  },
  breakpoints: {
    320: {
      slidesPerView: 1
...
const swiper_about_letters = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-letters-swiper', {
  spaceBetween: 20,
  navigation: {
    prevEl: '.letters-about-slider .prev',
    nextEl: '.letters-about-slider .next'
  },
  breakpoints: {
    320: {
      slidesPerView: 1
...
const swiper_products = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.products-swiper', {
  spaceBetween: 20,
  navigation: {
    prevEl: '.products-section-slider .prev',
    nextEl: '.products-section-slider .next'
  },
  breakpoints: {
    320: {
      slidesPerView: 2
...
const priceTabsBtns = document.querySelectorAll('.tabs__btn');
const priceTabsItems = document.querySelectorAll('.tabs__item');
const informationBtn = document.querySelectorAll('.information__btn');
const informationTabs = document.querySelectorAll('.information__tab');
function setAttributeTabs(elements1, elements2, slug) {
  elements1.forEach((el, i) => {
    el.setAttribute(`data-tab-btn-${slug}`, `${i + 1}`);
  });
  elements2.forEach((el, i) => {
    el.setAttribute(`data-tab-el-${slug}`, `${i + 1}`);
  });
}
setAttributeTabs(priceTabsBtns, priceTabsItems, 'price');
setAttributeTabs(informationBtn, informationTabs, 'info');
...
if (slider) {
  ...
  nouislider__WEBPACK_IMPORTED_MODULE_7__["default"].create(slider, {
    start: [20, 80],
    connect: true,
    range: {
      'min': 0,
...
const listener = () => {
  document.body.addEventListener('click', e => {
    ...
    if (target.dataset.filter) showOptions(target);
    if (target.classList.contains('filter-title')) closeFilterBlock(target);
    ...
    function closeFilterBlock(target) {
      const filter = target.closest('.filter');
      const options = filter.querySelectorAll('.filter-options');
      options.forEach(item => {
        item.classList.toggle('hidden');
      });
    }
    function changeTabPrice(target) {
      let currentId = target.dataset.tabBtnPrice;
      let element = document.querySelector(`[data-tab-el-price="${currentId}"]`);
      let activeEl = document.querySelector('.tabs__item.active');
      let activeBtn = document.querySelector('.tabs__btn._is-active');
      if (activeEl) activeEl.classList.remove('active');
      element.classList.add('active');
      if (activeBtn) activeBtn.classList.remove('_is-active');
      target.classList.add('_is-active');
    }
    function changeTabInfo(target) {
      let currentId = target.dataset.tabBtnInfo;
      let element = document.querySelector(`[data-tab-el-info="${currentId}"]`);
      let activeEl = document.querySelector('.information__tab._active');
      let activeBtn = document.querySelector('.information__btn._active');
      if (activeEl) activeEl.classList.remove('_active');
...
new HvrSlider('[data-slider="image"]');
